...
def graph_hp_trends(Sport,hp_cycle,hp_trend,variable_of_int):
    ...
    fig1.savefig(r'C:\Users\nikhil\Desktop\ECE143 HW\Olympic-Analysis-master\AnalyzedData\%d\HPFigures\%s_hptrends.png' %(variable_of_int,Sport))
    
    hp_cycle_graph = hp_cycle['count'].plot(figsize=(50,25));
    fig2 = hp_cycle_graph.get_figure()
    fig2.savefig(r'C:\Users\nikhil\Desktop\ECE143 HW\Olympic-Analysis-master\AnalyzedData\%d\HPFigures\%s_hpcycles.png' %(variable_of_int,Sport))
...
def plot_bar_PCA(per_var,labels,Sport,variable_of_int):
    ...
    plt.savefig(r'C:\Users\nikhil\Desktop\ECE143 HW\Olympic-Analysis-master\AnalyzedData\%d\PCA\%s_PCA_Bar.png' %(variable_of_int,Sport))
    plt.show()
...
def plot_scatter_PCA(pca_data,listof_indices,labels,per_var,Sport,variable_of_int):
    ...
    plt.show()
    fig2.get_figure().savefig(r'C:\Users\nikhil\Desktop\ECE143 HW\Olympic-Analysis-master\AnalyzedData\%d\PCA\%s_PCA_Scatter.png' %(variable_of_int,Sport)
...
def top_10_PCA(pca, listof_columns, Sport,variable_of_int):
    ...
    loading_scores[top_10_years].to_csv(r'C:\Users\nikhil\Desktop\ECE143 HW\Olympic-Analysis-master\AnalyzedData\%d\PCA\%s_top10_PCA.csv' %(variable_of_int,Sport))
